...
\item S3 Texture Compression (S3TC \footnote{, lossy texture compression algorithms allowing compression rates at around 4:1} - sometimes referred to as DXTn or DXTC),
\item depth textures,
...
caption=Create Canvas element and getthe context for rendering with WebGL.]
