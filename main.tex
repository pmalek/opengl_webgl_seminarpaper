...
\subsubsection{OpenGL ES version history}

Its most recent version at the time of writing of this paper is 3.0 \cite{opengl_es3_spec} and it is based on OpenGL 4.3.
OpenGL ES always provides compatibility with OpenGL's version that it has been based on, so for instance OpenGL ES 3.0 is compatible with OpenGL 4.3.
