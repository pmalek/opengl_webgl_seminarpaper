...
\lstinputlisting[label={lst:glsurfaceview_renderer_implementation},caption={Implementation of GLSurfaceView.Renderer that clears the screen to black on every frame.}]{./code/minimal_GLSurfaceView_Renderer.java}
...
%\lstinputlisting{./code/minimal_GLSurfaceView_Renderer.java}
%\end{filecode}
